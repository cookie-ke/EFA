        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                imgs, captions, cap_lens, class_ids, keys, wrong_caps, \
                                wrong_caps_len, wrong_cls_id, label = prepare_data(data)
                ...
                for i in range(len(netsD)):
                    ...
                    errD, d_loss_cls, d_loss_cls_fake = discriminator_loss(netsD[i], imgs[i], fake_imgs[i],
                                              ...
                                              wrong_caps_len, wrong_cls_id, label, i)
                    ...
                    #                                                            sent_emb, real_labels, fake_labels,
                    #                                                            words_embs, cap_lens, image_encoder,
                    #                                                            class_ids, w_words_embs,
                    #                                                            wrong_caps_len, wrong_cls_id, label,
                    #                                                            i)
                    #     errD.backward(retain_graph=True)
                    #     optimizersD[i].step()
                    #     errD_total += errD
                ...
                errG_total, G_logs = \
                    generator_loss(netsD, image_encoder, fake_imgs, real_labels,
                                   words_embs, sent_emb, match_labels, cap_lens, class_ids, style_loss, imgs, label)
