...
def prepare_data(data):
    imgs, captions, captions_lens, class_ids, keys, wrong_caps, wrong_caps_len, wrong_cls_id, label = data
    ...
    label = label[sorted_cap_indices].squeeze()
    ...
    return [real_imgs, captions, sorted_cap_lens,
            class_ids, keys, wrong_caps, w_sorted_cap_lens, wrong_cls_id, label]
...
class TextDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return imgs, caps, cap_len, cls_id, key, wrong_caps, wrong_cap_len, wrong_cls_id, label
    ...
    def get_label(self, key):
        ...
        self.data_dir
        self.filenames
        with open(os.path.join(self.data_dir, 'CelebAMask-HQ-attribute-anno.txt'), 'r') as f:
