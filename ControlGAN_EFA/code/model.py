...
class D_NET64(nn.Module):
    def __init__(self, b_jcu=True):
        ...
        self.img_code_s16 = encode_image_by_16times(ndf)  # 64->16
        if b_jcu:
...
class D_NET128(nn.Module):
    def __init__(self, b_jcu=True):
        ...
        nef = cfg.TEXT.EMBEDDING_DIM  # 256
        self.img_code_s16 = encode_image_by_16times(ndf)  # 64 -> 16
        self.img_code_s32 = downBlock(ndf * 8, ndf * 16)  # 8*8
        self.img_code_s32_1 = Block3x3_leakRelu(ndf * 16, ndf * 8) # 8*8
        #
        if b_jcu:
            self.UNCOND_DNET = D_GET_LOGITS(ndf, nef, bcondition=False)
        else:
...
class D_NET256(nn.Module):
    def __init__(self, b_jcu=True):
        ...
        self.img_code_s16 = encode_image_by_16times(ndf)   # 64 -> 16
        self.img_code_s32 = downBlock(ndf * 8, ndf * 16)   # 8*8
        self.img_code_s64 = downBlock(ndf * 16, ndf * 32)  # 4*4
